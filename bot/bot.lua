bot = dofile('/home/bot1/inline/data/utils.lua')
json = dofile('/home/bot1/inline/data/JSON.lua')
...
BASE = '/home/bot1/inline/bot/'
SUDO = 304240834 --sudo id
sudo_users = {304240834,123456789,Userid}
